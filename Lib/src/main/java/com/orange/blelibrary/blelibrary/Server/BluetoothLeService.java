...
import static com.orange.blelibrary.blelibrary.tool.FormatConvert.bytesToHex;
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                bleCallbackC.getBleServiceControl().displayGattServices(getSupportedGattServices());
            } else {
...
private void GetEXTRA_DATA(final BluetoothGattCharacteristic characteristic){
...
bleCallbackC.getBleServiceControl().getData=data;
    } else {
        bleCallbackC.getBleServiceControl().getData=data;
    }
}
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        mBluetoothGatt.setCharacteristicNotification(characteristic, true);
          ...
          if(descriptor!=null){
              ...
              ;
              for(byte a :val) {Log.d("寫入value",String.format("%02X", a));}
