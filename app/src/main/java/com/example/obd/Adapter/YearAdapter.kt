...
class YearAdapter(private val a:ArrayList<module>,val act: Activity,private val fragmentManager: androidx.fragment.app.FragmentManager)
    : androidx.recyclerview.widget.RecyclerView.Adapter<YearAdapter.ViewHolder>() {
