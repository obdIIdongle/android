...
/**
 * The <code>Util_CustomTextWatcher</code> class is used to add a TextWatcher to the
 * list of those whose methods are called whenever this TextView's text changes.
 *
 * @author IndexCqq
 * @version 1.00.00, 11 May 2015
 */
public class Util_CustomTextWatcher implements TextWatcher {

    private static final String TAG = "Util_CustomTextWatcher";
    ...
    /**
     * Creates an instance of <code>Util_CustomTextWatcher</code>.
     *
     * @param editText
     *        the editText to edit text.
     */
    public Util_CustomTextWatcher(EditText editText, int count) {
