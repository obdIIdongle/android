...
import com.example.obd.Beans.Bs_RetNode;
...
//        try{
//            return Util_Http_Command_Function.Register(LogoActivity.Companion.getAdmin(),LogoActivity.Companion.getPassword(),serialnum,"Distributor","spare","spare","spare","spare","spare","spare","spare","")==0;
//        }catch (Exception e){e.printStackTrace();return false;}
//    }
